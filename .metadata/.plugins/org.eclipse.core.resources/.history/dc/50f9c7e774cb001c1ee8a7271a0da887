...
import service.Covid19InfStateJsonService;
...
public class OpenAPIController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "guroPointFocInfoSvc.do":
			...
			break;
		case "covid19InfStateJsonPage.do":
			af = new ActionForward("covid/covid.jsp", false);
			break;
		case "covid19InfStateJson.do":
			Covid19InfStateJsonService service3 = new Covid19InfStateJsonService();
